      ...
      <div v-for="control in controls" :key="control.key">
        ...
        <div v-if="control.type === 'slider'" class="space-y-2">
          <input
            ...
            class="w-full accent-blue-500 font-medium"
          />
        </div>
        ...
        <select
          ...
          class="w-full px-3 py-2 bg-black/30 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-white font-medium"
        >
          <option
